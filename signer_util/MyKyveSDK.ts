import {
  ...
  import { getSigningKyveClient } from "~/signer_util/full-client";
  import { createKyveLCDClient } from "@kyvejs/sdk/dist/clients/lcd-client/client";
  ...
  import {
    ...
    SUPPORTED_WALLETS,
    SupportedChains,
  } from "@kyvejs/sdk/dist/constants";
  import {
    cosmostationMethods,
    CosmostationSigner,
  } from "@kyvejs/sdk/dist/utils/cosmostation-helper";
  import { KeplrAminoSigner } from "@kyvejs/sdk/dist/utils/keplr-helper";
  
  /** Class representing a KyveSDK. */
  export class MyKyveSDK {
    ...
    static verifyString(
      ...
      return verifyADR36Amino(
        PREFIX,
        MyKyveSDK.getAddressFromPubKey(pubKey),
